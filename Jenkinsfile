...
pipeline{
    ...
    stages {
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'DockerHub-Credential', toolName: 'Docker'){
                       ...
                       sh "docker tag reddit kenneedwin/reddit:latest "
                       sh "docker push kenneedwin/reddit:latest "
                    }
                }
            }
        }
        stage("Trivy App Image Scan"){
            steps{
                sh "trivy image kenneedwin/reddit:latest > trivy_image_analysis_report.txt"
            }
        }
